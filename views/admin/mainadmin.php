...
<a href="/bookbox/views/admin/addbook" style="position: absolute; color: black; font-size: 20px;right: 200px;">Добавить книгу</a>
    ...
    <?php foreach($booksList as $booksItem): $i++;?>
        ...
        <?php if($i%2 == 0):?>        
            <li style="display: flex; width: 850px;background: #eaeaea;">
                ...
                <div title='update' style="width: 140px; padding: 10px;"><a href="/bookbox/views/admin/updbook/<?php echo $booksItem['id'];?>" style="text-decoration: none;">редактировать</a></div>
